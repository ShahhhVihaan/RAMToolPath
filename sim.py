...
class App(tk.Frame):
    def __init__(self, master=None):
        ...
        self.planner = Planner('sample_gcode/test_big_box.gcode')

        # Initialize the starting coordinates
        self.start_x, self.start_y, self.start_z = 0, 0, 0.3
        self.scale_factor = 1  # Scale up factor for the trace line
    ...
    def start_trace(self):     
        ...
        for coord in self.planner.generate():
            ...
            if w!="G0": self.canvas.create_line(self.start_x, self.start_y, x, y, tags="trace")
            if w!="G0": self.canvas.create_line(self.start_x + 191*self.scale_factor, self.start_y, x + 191*self.scale_factor, y, tags="trace")
